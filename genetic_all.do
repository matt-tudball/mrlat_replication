...
// Format genetic data
/*
import delimited "path to genetic .raw file (all)", delimiter(space) 
...
saveold "$yourpath/richardson_data.dta", replace version(12)

// Ordered probit regression
oprobit d_size rs* c_sex c_age i.c_batch
foreach var of varlist rs* {
...
saveold "$yourpath/richardson_twosample.dta", replace version(12)
outsheet using "$yourpath/richardson_twosample.csv", replace comma 
